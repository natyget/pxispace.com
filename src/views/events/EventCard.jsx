...
import { Calendar, MapPin, Ticket, Heart, Maximize2 } from 'lucide-react';
  ...
  return (
    <div className="group relative flex flex-col glass-dark rounded-[3rem] border border-white/5 hover:border-pxi-purple/30 transition-all duration-500 overflow-hidden">
      <div className="relative h-72 overflow-hidden">
        ...
        >
          <Heart size={20} className={favorited ? 'fill-pink-500 text-pink-500' : ''} />
        </button>
      ...
      <div className="p-10 flex-1 flex flex-col">
        ...
        <div className="mt-auto flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2 justify-end">
            <Button
              variant="glass"
              className="!px-5 !py-3 !text-[10px] uppercase tracking-widest border-white/10"
