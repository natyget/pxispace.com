      ...
      <section className="container mx-auto px-6 mb-32 text-center lg:text-left">
        ...
        <div className="glass-dark p-8 md:p-12 rounded-[3rem] border border-white/10 max-w-4xl shadow-2xl">
          <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed italic">
            PXI was created to solve a simple problem: the moments that make an
            event unforgettable shouldn't get lost in someone else's camera
            roll. We built PXI to unify the entire experience—planning,
            capturing, and reliving—into one seamless place.
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-24">
          ...
          <div className="lg:w-1/2 order-1 lg:order-2">
            ...
            <div className="space-y-6 text-lg text-zinc-400 font-medium leading-relaxed">
              <p>
                We used to throw incredible parties, nights full of energy,
                people, and memories. But the best photos always vanished into
                someone else's camera roll. PXI exists so that never happens
                again.
              </p>

              <p>
                It started with a group of international friends who loved
                bringing people together. We hosted event after event, learning
                what makes a night unforgettable… until the logistics grew
                louder than the fun, and we stepped back.
              </p>

              <p className="text-white">
                In our own private gatherings, a deeper frustration appeared:
                moments were scattered across dozens of phones. Months later,
                one of us would uncover a buried photo, the perfect angle of
                you—and that rediscovery felt electric.
              </p>
            </div>
          </div>
      ...
      <section className="bg-zinc-900/30 py-32 mb-40 border-y border-white/5 relative">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-zinc-500 text-xl md:text-2xl font-medium max-w-3xl mx-auto mb-16">
            We're a small, mission-driven team, organizers, builders, and
            storytellers, who started PXI to solve a real problem: keep the joy
            of live events alive by making memories effortless to capture and
            share.
          </p>
          ...
          <div className="max-w-5xl mx-auto relative group">
            ...
            <img
              src="https://images.unsplash.com/photo-1511632765486-a01980e01a18?q=80&w=2040"
              alt="Team Group"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="ticket-shape bg-gradient-to-br from-zinc-900 to-pxi-charcoal p-10 md:p-20 rounded-[3rem] border border-white/5 relative text-center">
            ...
            <p className="text-xl md:text-2xl text-zinc-400 font-medium leading-relaxed mb-12">
              Our mission is simple: to make it easy for people to connect,
              celebrate, and remember. PXI is designed to remove the stress from
              organizing and amplify the joy of experiencing something together.
              Whether digital or physical, every memory deserves to live fully.
            </p>
