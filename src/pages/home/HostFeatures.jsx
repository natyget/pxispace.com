        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-24">
            ...
            <div className="space-y-8 md:space-y-10">
              ...
              <div className="flex flex-col md:flex-row items-center lg:items-start gap-5 md:gap-6">
                ...
                <div className="max-w-md">
                  ...
                  <p className="text-zinc-500 font-medium">
                    Manage ticketing, invites, and communication in one place.
                    Scale your events without the manual labor.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center lg:items-start gap-5 md:gap-6">
                ...
                <div className="max-w-md">
                  ...
                  <p className="text-zinc-500 font-medium">
                    Every guest is a creator. Effortlessly collect high-quality
                    content ready for your next promotion.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center lg:items-start gap-5 md:gap-6">
                ...
                <div className="max-w-md">
                  ...
                  <p className="text-zinc-500 font-medium">
                    Turn one-time ticket buyers into a loyal community that
                    lives for your next drop.
                  </p>
                </div>
              </div>
          ...
          <div className="lg:w-1/2 relative flex justify-center w-full">
            ...
            <div className="relative">
              <PhoneMockup
                src="https://picsum.photos/400/850?random=50"
                alt="Create Event Screen"
                className="relative z-10 h-[550px] md:h-[650px] shadow-[0_0_60px_rgba(45,27,78,0.4)] rotate-3 hover:rotate-0 transition-all duration-700"
              />

              {/* Floating Stats Card */}
              <div className="absolute -bottom-8 -left-4 md:-left-12 z-20 glass-dark border border-white/10 p-4 rounded-2xl shadow-2xl w-40 md:w-48 animate-float">
