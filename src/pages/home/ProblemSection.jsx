    ...
    <section className="py-20 md:py-24 bg-[#080808] relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className="ticket-shape bg-gradient-to-br from-pxi-purple to-pink-600 p-8 md:p-20 rounded-[2.5rem] md:rounded-[3rem] relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-12">
              ...
              {/* QR Section */}
              <div className="w-48 h-48 md:w-64 md:h-64 glass rounded-[2rem] md:rounded-[2.5rem] flex flex-col items-center justify-center border-white/20 p-6 md:p-8 flex-shrink-0">
            ...
            {/* Dash Line Divider */}
            <div className="absolute top-0 bottom-0 right-[32%] border-l-2 border-dashed border-white/20 hidden md:block"></div>
          </div>
        </div>
      </div>
    </section>
