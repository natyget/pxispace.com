...
const albums = [
  ...
  },
  {
    ...
    photos: 65,
    members: 40,
    img: "https://picsum.photos/600/600?random=13",
  },
];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <p className="text-zinc-500 text-lg md:text-xl font-medium max-w-xl mx-auto mb-10">
            PXI automatically organizes your event history into beautiful,
            interactive albums. Memories shouldn't live in a folder.
          </p>
